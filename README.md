...
python gen2.py -c single_template
...
Затем используйте:
```bash
python gen2.py -c имя_конфигурации
```
...
python gen2.py -c simple_multiple
```
...
- **gen2.py v2.6** - улучшенная версия с шаблонами, автоматической организацией файлов и конфигурационными файлами
